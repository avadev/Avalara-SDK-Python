...
------------ | ------------- | ------------- | -------------
**type** | **str** | Type of the form, always W9 for this model. | [optional] [readonly] 
...
w9_form_data_model_instance = W9FormDataModel.from_json(json)
# print the JSON string representation of the object
print(W9FormDataModel.to_json())

# convert the object into a dict
w9_form_data_model_dict = w9_form_data_model_instance.to_dict()
# create an instance of W9FormDataModel from a dict
w9_form_data_model_from_dict = W9FormDataModel.from_dict(w9_form_data_model_dict)
```
