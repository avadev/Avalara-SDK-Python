...
w8_imy_form_response_instance = W8ImyFormResponse.from_json(json)
# print the JSON string representation of the object
print(W8ImyFormResponse.to_json())

# convert the object into a dict
w8_imy_form_response_dict = w8_imy_form_response_instance.to_dict()
# create an instance of W8ImyFormResponse from a dict
w8_imy_form_response_from_dict = W8ImyFormResponse.from_dict(w8_imy_form_response_dict)
```
