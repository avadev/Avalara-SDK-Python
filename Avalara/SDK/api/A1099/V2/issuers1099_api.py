...
class Issuers1099Api(object):
    ...
    def __set_configuration(self, api_client):
        ...
        self.create_issuer_endpoint = _Endpoint(
            settings={
                'response_type': (IssuerWriteResponse,),
                'auth': [
                    'bearer'
                ],
    ...
    def get_issuers(
        ...
        **kwargs
        ...
        List issuers (also known as Payers). Filterable fields are businessName, businessName2, referenceId, taxYear, firstName, and lastName.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update_issuer(
        ...
        **kwargs
        ...
        Update an issuer (also known as a Payer). When the payload violates field-level business rules, the issuer is still persisted and the response body includes a `validationErrors[]` array describing each violation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
