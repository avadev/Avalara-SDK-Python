...
class Form1099ListRequest(BaseModel):
    ...
    Form1099ListRequest
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Available form types: * `1042-S` * `1095-B` * `1095-C` * `1099-DIV` * `1099-INT` * `1099-K` * `1099-MISC` * `1099-NEC` * `1099-R` * `W-2` ")
