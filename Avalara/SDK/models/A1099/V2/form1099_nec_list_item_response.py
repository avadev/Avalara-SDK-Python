...
class Form1099NecListItemResponse(BaseModel):
    """
    Form1099NecListItemResponse
    """ # noqa: E501
    nonemployee_compensation: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Nonemployee compensation", alias="nonemployeeCompensation")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Form1099NecListItemResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Form1099NecListItemResponse from a dict"""
        if obj is None:
            return None
