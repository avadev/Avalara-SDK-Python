...
from Avalara.SDK.models.A1099.V2.A1099.V2.A1099.V2.A1099.V2.covered_individual_reference_response import CoveredIndividualReferenceResponse
...
class Form1095BListItemResponse(BaseModel):
    """
    ...
    covered_individuals: Optional[List[CoveredIndividualReferenceResponse]] = Field(default=None, description="Covered individuals information", alias="coveredIndividuals")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Form1095BListItemResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Form1095BListItemResponse from a dict"""
        if obj is None:
            return None
