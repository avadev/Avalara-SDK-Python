...
form1095_b_list_item_response_instance = Form1095BListItemResponse.from_json(json)
# print the JSON string representation of the object
print(Form1095BListItemResponse.to_json())

# convert the object into a dict
form1095_b_list_item_response_dict = form1095_b_list_item_response_instance.to_dict()
# create an instance of Form1095BListItemResponse from a dict
form1095_b_list_item_response_from_dict = Form1095BListItemResponse.from_dict(form1095_b_list_item_response_dict)
```
