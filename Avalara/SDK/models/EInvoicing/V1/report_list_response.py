...
class ReportListResponse(BaseModel):
    ...
    """ # noqa: E501
    recordset_count: Optional[StrictStr] = Field(default=None, description="Count of reports matching the filter for the given query. Present when the request includes $count=true.", alias="@recordsetCount")
    next_link: Optional[StrictStr] = Field(default=None, description="URL to retrieve the next page of results when more items match the query. Omitted or null when there is no next page.", alias="@nextLink")
    value: List[ReportItem] = Field(description="Array of reports matching the query parameters.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ReportItem.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
