...
------------ | ------------- | ------------- | -------------
**employee_first_name** | **str** | Employee first name (max 15 chars). | [optional] 
**employee_middle_name** | **str** | Employee middle name (max 15 chars, optional). | [optional] 
**employee_last_name** | **str** | Employee last name (max 20 chars). | [optional] 
...
form1099_w2_instance = Form1099W2.from_json(json)
# print the JSON string representation of the object
print(Form1099W2.to_json())

# convert the object into a dict
form1099_w2_dict = form1099_w2_instance.to_dict()
# create an instance of Form1099W2 from a dict
form1099_w2_from_dict = Form1099W2.from_dict(form1099_w2_dict)
```
