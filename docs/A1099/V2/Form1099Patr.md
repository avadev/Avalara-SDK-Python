...
form1099_patr_instance = Form1099Patr.from_json(json)
# print the JSON string representation of the object
print(Form1099Patr.to_json())

# convert the object into a dict
form1099_patr_dict = form1099_patr_instance.to_dict()
# create an instance of Form1099Patr from a dict
form1099_patr_from_dict = Form1099Patr.from_dict(form1099_patr_dict)
```
