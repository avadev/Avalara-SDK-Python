...
class DirectorySearchResponseValueInnerSupportedDocumentTypesInner(BaseModel):
    """
    DirectorySearchResponseValueInnerSupportedDocumentTypesInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Document type name.")
    value: Optional[StrictStr] = Field(default=None, description="Document type identifier.")
    supported_by_trading_partner: Optional[StrictBool] = Field(default=None, description="Does trading partner support receiving this document type", alias="supportedByTradingPartner")
    ...
    __properties: ClassVar[List[str]] = ["name", "value", "supportedByTradingPartner", "supportedByAvalara"]
