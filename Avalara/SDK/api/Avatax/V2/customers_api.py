...
from Avalara.SDK.model.Avatax.V2.certificate_model_fetch_result import CertificateModelFetchResult
...
class CustomersApi(object):
    ...
    def __set_configuration(self, api_client):
        ...
        self.create_customers_endpoint = _Endpoint(
            settings={
                'response_type': ([CustomerModel],),
                'auth': [
                    'Bearer',
                    'OAuth'
                ],
                'endpoint_path': '/avatax/companies/{companyId}/customers',
                'operation_id': 'create_customers',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.list_certificates_for_customer_endpoint = _Endpoint(
            settings={
                'response_type': (CertificateModelFetchResult,),
                'auth': [
                    'Bearer',
                    'OAuth'
                ],
                'endpoint_path': '/avatax/companies/{companyId}/customers/{customerCode}/certificates',
                'operation_id': 'list_certificates_for_customer',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_customer_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/avatax/companies/{companyId}/customers/{customerCode}',
    ...
    def create_customers(
        ...
        **kwargs
        ...
        """Create customers for this company  # noqa: E501
        ...
        >>> thread = api.create_customers(company_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            ...
            body ([CustomerModel]): The list of customer objects to be created. [optional]
        ...
        kwargs['company_id'] = \
            company_id
        return self.create_customers_endpoint.call_with_http_info(**kwargs)
    ...
    def list_certificates_for_customer(
        ...
        **kwargs
        ...
        """List certificates linked to a customer  # noqa: E501
        ...
        >>> thread = api.list_certificates_for_customer(company_id, customer_code, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['customer_code'] = \
            customer_code
        return self.list_certificates_for_customer_endpoint.call_with_http_info(**kwargs)
    ...
    def update_customer(
        ...
        **kwargs
        ...
        """Update a single customer  # noqa: E501
        ...
        >>> thread = api.update_customer(company_id, customer_code, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            x_avalara_client (str): Identifies the software you are using to call this API.  For more information on the client header, see [Client Headers](https://developer.avalara.com/avatax/client-headers/) .. [optional] if omitted the server will use the default value of "Swagger UI; 22.7.0; Custom; 1.0"
            body (CustomerModel): The new customer model that will replace the existing record at this URL. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
