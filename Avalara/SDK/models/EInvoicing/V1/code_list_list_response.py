...
class CodeListListResponse(BaseModel):
    ...
    """ # noqa: E501
    recordset_count: Optional[StrictStr] = Field(default=None, description="Count of code lists for the given query parameters", alias="@recordsetCount")
    next_link: Optional[StrictStr] = Field(default=None, alias="@nextLink")
    value: List[CodeListSummary] = Field(description="Array of code lists matching query parameters")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [CodeListSummary.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
